...
// Hindi Edition - हिंदी संस्करण - Dark Mode
...
#v(4cm)
#align(center)[
  #text(size: 15pt, fill: dark-primary, weight: "medium")[इंद्र ने कृष्ण को क्या सिखाया]
  #v(1cm)
  #text(style: "italic", size: 11pt, fill: dark-muted)[आश्रिस चौधरी]
]
#pagebreak()
...
#v(1fr)
#align(center)[
  #text(style: "italic", size: 10pt, fill: dark-muted)[
    इंद्रगीता: इंद्र ने कृष्ण को क्या सिखाया \
    आश्रिस चौधरी \
    प्रथम संस्करण, २०२६ \
  ]
