...
// =====================================
// PRINT EDITION - V7
// Dark cover, Light interior, Dark back cover

#import "template.typ": *

// Light interior for print
...
// Dark cover with image (full bleed)
