...
Now tell me: will that man check his measurements twice? Will he argue with the architect when the design is flawed? Will he argue with the king who wants it cheaper? Will he stay late into the night correcting errors? Will he fight for the temple's perfection?

#speaker[Krishna] If he is wise, he will do his duty without...

#speaker[Indra] He will do his duty. The minimum. What is required. Because anything more would be #emph[attachment to outcome]. Anything more would be desire for fruit.
...
#speaker[Krishna] You misread me, Shakra. You misread the teaching.

#speaker[Indra] Then clarify.

#speaker[Krishna] The teaching was never about numbness. It was about #emph[flow]. The archer who thinks about the prize while aiming misses the target. The coder who worries about the deadline while debugging makes more errors. The athlete who watches the scoreboard instead of the ball loses the game.

I taught focus so intense that the self disappears into the action. Not indifference to outcome, but absorption so complete that the outcome becomes inevitable.

#speaker[Indra] #stage[slowly] Then your teaching, properly understood, is about the state where the archer becomes the arrow. The state where obsession with the score ruins your aim, so you let go of the score and #emph[become] the game.

#speaker[Krishna] Yes.

#speaker[Indra] But that is not what your followers heard. They heard "don't desire" and became numb. They stopped caring about the target altogether. They confused the means with the end.

#speaker[Krishna] That is their failure, not mine.

#speaker[Indra] Is it? When an Olympian wakes at four in the morning to train, does she want the gold medal or not? When a coder enters the hackathon, when a gamer faces the final boss, when an archer aims---the wanting is what puts them in the arena. The flow-state comes during the action, but the #emph[wanting] brings them to the starting line.

You were teaching flow. But you made wanting itself suspect. And a man who is ashamed of his wanting never reaches the arena where flow is possible.
